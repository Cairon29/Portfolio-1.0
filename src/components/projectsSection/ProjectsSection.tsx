    ...
    <div>
        ...
        <section id='projects-section'>
            ...
            <ProjectCard 
              ...
              projectDescription=' A generic e-commerce website that allows users to log-in and out, browse products, filter, add them to the cart, and simulate a checkout process by sending a confirmation email to the user with the order details.' 
            />
        </section>
    </div>
  ) 
